...
DECLARE carritoID INT;
    ...
    CodigoCupon VARCHAR(20) NOT NULL UNIQUE,
    Descuento DECIMAL(10,2) NOT NULL,
    MinimoCompra DECIMAL(10,2) NULL,
...
CREATE TABLE CuponesUsados (
	CUsadoID INT AUTO_INCREMENT PRIMARY KEY,
...
CREATE TABLE Devouciones (
    ...
    Cantidad INT DEFAULT 1,
    Motivo VARCHAR(255),
    Estado ENUM('Solicitada','Aprobada','Rechazada','En proceso', 'Finalizada') DEFAULT 'Solicitada',
    MetodoResolucion ENUM('Reembolso','Cambio','NotaCredito')  NOT NULL,
    FechaSolicitud DATETIME DEFAULT CURRENT_TIMESTAMP,
    FechaResolucion DATETIME NULL, 
    Observaciones TEXT NULL,
    MontoReembolso DECIMAL(10,2) DEFAULT 0.00
);
...
MetodoResolucion,
Observaciones,
MontoReembolso) VALUES (3, 4, 2, 5, 'Producto Dañado', 'Cambio', 'El producto llego con manchas blancas y esta roto de una parte.', 0.00);
