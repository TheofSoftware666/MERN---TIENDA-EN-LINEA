...
import {  GetMetricsOverView, GetOrderIncomes, GetProductsTop, GetProductsTopVisit, GetOrderStatust, GetReturnStatust } from "../controllers/dashboardController.js";
...
router.post('/CheckPaymentCart', checkAuth, checkPreviousPayment);
        ...
        // .post('/webhook/stripe', express.raw({ type: 'application/json' }), ProcessPayment);

router.post('/webhook/stripe', express.raw({ type: 'application/json' }), ProcessPayment);

router.get('/Admin/MetricsOverView', checkAuth, GetMetricsOverView)
        .get('/Admin/OrderIncomes', checkAuth, GetOrderIncomes)
        .get('/Admin/ProductsTop', checkAuth, GetProductsTop)
        .get('/Admin/ProductsTopVisit', checkAuth, GetProductsTopVisit)
        .get('/Admin/OrderStatus', checkAuth, GetOrderStatust)
        .get('/Admin/ReturnStatus', checkAuth, GetReturnStatust);
