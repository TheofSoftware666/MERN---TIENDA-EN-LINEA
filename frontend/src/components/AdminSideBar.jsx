        ...
        <div className={`flex items-center gap-3 transition-all duration-300 ${!expanded && 'justify-center'}`}>
          ...
          {expanded && (
            <div className="flex-1 overflow-hidden">
              ...
              <p className="text-xs text-gray-400 font-medium truncate">Altisys Shop</p>
            </div>
          )}
      ...
      <div className={`p-4 border-t border-gray-700/50 ${!expanded && 'flex justify-center'}`}>
        <div className="flex items-center gap-3">
          <div className="relative">
            ...
            <div className="w-9 h-9 rounded-full bg-gradient-to-br from-purple-500 to-indigo-600 ring-2 ring-gray-700 flex items-center justify-center text-white font-medium text-sm">
              {user.user?.nombre ? user.user.nombre.substring(0, 2).toUpperCase() : 'US'}
            </div>
          ...
          {expanded && (
            <div className="flex-1 min-w-0">
              <p className="text-sm font-medium text-white truncate">{user.user?.nombre || 'Usuario'}</p>
