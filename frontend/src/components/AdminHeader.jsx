...
const AdminHeader = ({ onToggleSidebar, usuario }) => {
  const [openNoti, setOpenNoti] = useState(false);
  const [openProfile, setOpenProfile] = useState(false);
  const [searchOpen, setSearchOpen] = useState(false);

  const user = {
    name: usuario?.nombre || "Admin User",
    role: "Administrador",
    avatar: usuario?.nombre || "Admin User"
  };
      ...
      <div className="flex items-center justify-between px-4 lg:px-8 py-3">
        ...
        <div className="flex items-center gap-2">
          ...
          <div className="relative">
            ...
            >
              <div className="relative">
                <div className="w-9 h-9 rounded-full bg-gradient-to-br from-purple-500 to-indigo-600 ring-2 ring-white shadow-sm flex items-center justify-center text-white font-medium text-sm">
              ...
              <>
                ...
                <div className="absolute right-0 mt-2 w-56 bg-white rounded-2xl shadow-xl border border-gray-200/80 overflow-hidden z-50 animate-in slide-in-from-top-5 duration-200">
                  ...
                  <div className="py-2">
                    ...
                    <Link to="/Admin/Configuracion" onClick={() =>  setOpenProfile(false)} className="flex items-center gap-3 px-4 py-2.5 text-sm text-gray-700 hover:bg-gray-50/80 transition-colors duration-150">
                    ...
                    <Link to="/" onClick={() => {
                      ...
                      setOpenProfile(false);
                    }} className="flex items-center gap-3 px-4 py-2.5 text-sm text-red-600 hover:bg-red-50/80 transition-colors duration-150">
