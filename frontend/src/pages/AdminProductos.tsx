...
const AdminProductos = () => {
  ...
  const cargarProductos = async () => {
    try {
      setLoading(true);
      const productosData = await GetProductsAdmin(999);
  ...
  const GetProductsAdmin = async (limit = 200) => {
    try {
      ...
      <div className="mb-6">
        <div className="flex flex-wrap gap-3">
          ...
          <button 
            ...
            className="flex items-center gap-2 px-4 py-3 bg-gradient-to-r from-blue-600 to-green-600 hover:from-emerald-700 hover:to-green-700 text-white rounded-xl font-medium transition-all shadow-md hover:shadow-lg"
          >
            <Tag size={20} />
            Nueva Marca
          </button>
          <button 
            ...
            className="flex items-center gap-2 px-4 py-3 bg-blue-600 hover:from-violet-700 hover:to-violet-700 text-white rounded-xl font-medium transition-all shadow-md hover:shadow-lg"
          >
            <Layers size={20} />
            Nueva Categoría
          </button>
              ...
              >
                ...
                <div className="p-5">
                  ...
                  <div className="flex items-center justify-between text-sm text-gray-600 mb-4">
                    ...
                    <span>Visitas: <strong className="text-gray-900">{producto?.Visits}</strong></span>
                  </div>
